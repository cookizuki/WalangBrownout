...
export interface SupplierFormValues { name: string; contact: string; email: string; phone: string; }
...
export function SupplierDirectoryForm({
  ...
  const submit = (e: React.FormEvent) => {
    ...
    onSave({ name: name.trim(), contact: contact.trim(), email: email.trim(), phone: phone.trim() });
  };
